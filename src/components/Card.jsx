...
const Card = ({ title, price, list, i }) => {
    ...
    return (
        <>
            ...
            >
                <img src={uviBackgrounded} alt={`${title} card`} />
                ...
                <div className='w-full flex justify-end p-2'>
                    <button className='py-3.5 px-6 text-white font-bold leading-6 rounded-full bg-gradient-to-r from-[#460082] to-[#3D235A]'>Adquirir</button>
                </div>
            </div>
        </>
    );
